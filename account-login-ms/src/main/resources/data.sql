...
values(101, 'Puspak', 'password1', 'user1@gmail.com');

insert into USER_TBL(id,USER_NAME,PASSWORD,EMAIL)
values(102, 'Rakesh','password2', 'user2@gmail.com');

insert into USER_TBL(id,USER_NAME,PASSWORD,EMAIL)
values(103, 'Indra','password3', 'user3@gmail.com');

insert into USER_TBL(id,USER_NAME,PASSWORD,EMAIL)
values(104, 'Mana','password4', 'user4@gmail.com');
